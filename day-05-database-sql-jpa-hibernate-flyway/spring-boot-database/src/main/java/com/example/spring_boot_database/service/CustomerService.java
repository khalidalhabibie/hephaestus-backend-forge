...
import com.example.spring_boot_database.util.LogSanitizerUtil;
...
public class CustomerService {
    ...
    public CustomerResponse createCustomer(CreateCustomerRequest request) {
        ...
        try {
            ...
            log.info("event_name=customer_created customer_id={}", saved.getId(), LogSanitizerUtil.maskNik(saved.getNik()));
